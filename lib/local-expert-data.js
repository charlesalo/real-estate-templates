...
export const NEIGHBORHOODS = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1459535653751-d571815e906b?w=800&q=80',
    medianPrice: '$3.8M',
    activeListings: 24,
    vibes: ['Quiet', 'Literary', 'Leafy'],
    quote: 'The block where Bleecker bends — the one that makes you forget what borough you\'re in.',
    walkScore: 98,
    guideMinutes: 12,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1534443923570-8366b5d16a08?w=800&q=80',
    medianPrice: '$4.1M',
    activeListings: 18,
    vibes: ['Loft-Lined', 'Polished', 'Calm'],
    quote: 'Duane Park at seven a.m. — the only triangle in Manhattan where you can hear your own footsteps.',
    walkScore: 97,
    guideMinutes: 10,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1657763889378-f23814ae3464?w=800&q=80',
    medianPrice: '$2.2M',
    activeListings: 41,
    vibes: ['Classic', 'Stately', 'Park-Side'],
    quote: 'Park Avenue in October — white gloves, gold leaves, and not a single person in a hurry.',
    walkScore: 96,
    guideMinutes: 11,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1577001092099-24846c097bab?w=800&q=80',
    medianPrice: '$2.9M',
    activeListings: 16,
    vibes: ['Historic', 'Hushed', 'Skyline'],
    quote: 'The Promenade at dusk — Manhattan performs, and Brooklyn gets the good seats.',
    walkScore: 97,
    guideMinutes: 12,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1611324023056-c223a0f9a856?w=800&q=80',
    medianPrice: '$1.85M',
    activeListings: 29,
    vibes: ['Cobbled', 'Creative', 'Cinematic'],
    quote: 'Washington Street before nine — the bridge framed between warehouses, and the whole street to yourself.',
    walkScore: 95,
    guideMinutes: 9,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1698281408696-222848ae8d74?w=800&q=80',
    medianPrice: '$2.4M',
    activeListings: 33,
    vibes: ['Leafy', 'Family-First', 'Easygoing'],
    quote: 'Saturday at Grand Army Plaza — strollers, sourdough, and Olmsted\'s favorite park doing the heavy lifting.',
    walkScore: 96,
    guideMinutes: 10,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1680715107613-21b75f10dfca?w=800&q=80',
    medianPrice: '$2.8M',
    activeListings: 22,
    vibes: ['Cast-Iron', 'Gallery-Bred', 'Iconic'],
    quote: 'Greene Street after a rain — cast iron, cobblestones, and the city\'s best-looking shortcut.',
    walkScore: 99,
    guideMinutes: 9,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1559081548-c5bbb6222948?w=800&q=80',
    medianPrice: '$1.9M',
    activeListings: 19,
    vibes: ['Tucked-Away', 'Brownstone', 'Neighborly'],
    quote: 'Clinton Street on a Sunday — stoops, strollers, and a bakery line that\'s worth it.',
    walkScore: 96,
    guideMinutes: 8,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1624553348093-ed95c718f37b?w=800&q=80',
    medianPrice: '$2.1M',
    activeListings: 31,
    vibes: ['Artful', 'High-Line', 'Connected'],
    quote: 'Tenth Avenue from the High Line — galleries below, water towers above, the city mid-sentence.',
    walkScore: 98,
    guideMinutes: 10,
...
// ── Sold Listings (Recent Sales) ───────────────────────────────────────────────

export const SOLD_LISTINGS = [
  {
    id: 'sl-1',
    address: '88 Greene Street, Loft 5',
    neighborhood: 'SoHo',
    city: 'New York',
    listPrice: 3450000,
    soldPrice: 3610000,
  ...
  },
  {
    ...
    daysOnMarket: 27,
    listingBrokerage: 'Compass Real Estate LLC',
    mlsId: 'REBNY-2025-2087',
    image: 'https://images.unsplash.com/photo-1560185007-5f0bb1866cab?w=1200&q=80',
  },
  {
    id: 'sl-3',
    address: '198 Kane Street',
