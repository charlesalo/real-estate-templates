...
import HeroSearchFocused from '@/components/sections/HeroSearchFocused'
          ...
          <div className="grid lg:grid-cols-2 rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="bg-[#FAFAF8] px-8 py-16 lg:px-16 lg:py-24">
              ...
              <form className="space-y-3">
                <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-white border border-[#D5DBE9] focus-within:border-[#1A2D5A] transition-colors">
                  ...
                  <input type="text" placeholder="Name" className="flex-1 text-sm text-[#111827] placeholder:text-[#9CA3AF] outline-none bg-transparent" />
                </div>
                <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-white border border-[#D5DBE9] focus-within:border-[#1A2D5A] transition-colors">
                  <svg className="w-5 h-5 text-[#9CA3AF] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                  </svg>
                  <input type="email" placeholder="Email" className="flex-1 text-sm text-[#111827] placeholder:text-[#9CA3AF] outline-none bg-transparent" />
                </div>
                <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-white border border-[#D5DBE9] focus-within:border-[#1A2D5A] transition-colors">
                  <svg className="w-5 h-5 text-[#9CA3AF] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                  ...
                  <input type="tel" placeholder="Phone" className="flex-1 text-sm text-[#111827] placeholder:text-[#9CA3AF] outline-none bg-transparent" />
                </div>

                <button type="submit" className="w-full py-3.5 bg-[#1A2D5A] text-white text-xs font-bold tracking-[0.2em] uppercase rounded-lg hover:bg-[#243870] transition-colors">
                  Subscribe
                </button>

                <div className="flex items-start gap-3 pt-1">
                  <input type="checkbox" required id="newsletter-consent" className="mt-0.5 w-3.5 h-3.5 flex-shrink-0 accent-[#1A2D5A]" />
                  <label htmlFor="newsletter-consent" className="text-[10px] text-[#9CA3AF] font-sans leading-relaxed">
