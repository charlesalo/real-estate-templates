        ...
        <div className="grid lg:grid-cols-2 rounded-xl overflow-hidden shadow-lg">
          ...
          <div className="bg-[#FAFAF8] px-8 py-16 lg:px-16 lg:py-24">
            ...
            <form className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full py-3.5 bg-[#1A2D5A] text-white text-xs font-bold tracking-[0.2em] uppercase rounded-lg hover:bg-[#243870] transition-colors"
              >
                Subscribe
              </button>
              ...
              <div className="flex items-start gap-3 pt-1">
                <input
                  ...
                  required
                  id="blog-consent"
                  className="mt-0.5 w-3.5 h-3.5 flex-shrink-0 accent-[#1A2D5A]"
                />
                <label htmlFor="blog-consent" className="text-[10px] text-[#9CA3AF] font-sans leading-relaxed">
