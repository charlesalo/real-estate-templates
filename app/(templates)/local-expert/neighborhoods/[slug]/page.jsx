    ...
    <>
      ...
      <section className="relative pt-0 pb-0" style={{ backgroundColor: '#F8F3EB' }}>
        <div className="relative h-[55vh] min-h-[400px]">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-12 max-w-7xl mx-auto">
            <Link href="/local-expert/neighborhoods" className="inline-flex items-center gap-1.5 text-[12px] text-white/50 hover:text-white transition-colors mb-4">
              <ArrowLeft size={12} /> All Neighborhoods
            </Link>
            <p className="text-[12px] tracking-[0.4em] uppercase text-white/40 mb-2">{neighborhood.borough}</p>
      ...
      <section className="py-[24px] border-b border-[#E5E0D8]" style={{ backgroundColor: '#F4F0EA' }}>
        <div className="max-w-7xl mx-auto px-5 lg:px-8 flex flex-wrap gap-8">
          <div><div className="text-[24px] font-normal text-[#24180F]" style={{ fontFamily: 'var(--font-gelasio, Georgia, serif)' }}>{neighborhood.medianPrice}</div><div className="text-[12px] uppercase tracking-wider text-[#24180F]/40 mt-0.5">Median Price</div></div>
          <div><div className="text-[24px] font-normal text-[#24180F]" style={{ fontFamily: 'var(--font-gelasio, Georgia, serif)' }}>{neighborhood.activeListings}</div><div className="text-[12px] uppercase tracking-wider text-[#24180F]/40 mt-0.5">Active Listings</div></div>
          <div><div className="text-[24px] font-normal text-[#24180F]" style={{ fontFamily: 'var(--font-gelasio, Georgia, serif)' }}>{neighborhood.highlights.length}</div><div className="text-[12px] uppercase tracking-wider text-[#24180F]/40 mt-0.5">Key Highlights</div></div>
        </div>
      </section>
      ...
      <section className="py-[64px] lg:py-[80px]" style={{ backgroundColor: '#F8F3EB' }}>
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          <p className="text-[16px] text-[#24180F]/65 leading-relaxed">{neighborhood.description}</p>
          <div className="mt-10">
            <h2 className="text-[19px] font-normal text-[#24180F] mb-4" style={{ fontFamily: 'var(--font-gelasio, Georgia, serif)' }}>What to know</h2>
            <ul className="space-y-2.5">
              {neighborhood.highlights.map((h) => (
                <li key={h} className="flex items-center gap-2.5 text-[16px] text-[#24180F]/60">
        ...
        <section className="py-[64px] lg:py-[80px]" style={{ backgroundColor: '#F4F0EA' }}>
          <div className="max-w-7xl mx-auto px-5 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-[34px] font-normal text-[#24180F]" style={{ fontFamily: 'var(--font-gelasio, Georgia, serif)' }}>
                Homes in {neighborhood.name}
              </h2>
              <Link href={`/local-expert/listings?q=${encodeURIComponent(neighborhood.name)}`} className="text-[13px] font-semibold text-[#24180F]/40 hover:text-[#24180F] transition-colors">
                View all →
              </Link>
            </div>
