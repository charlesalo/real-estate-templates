...
// Data-driven content (testimonial, recent sales) is fetched in the parent
// server component (page.jsx) from Sanity, with demo-data fallback, and
// passed down as props here since this is an interactive client component.
export default function HomeValuationClient({ testimonial, soldListings }) {
    ...
    <section className="py-[96px] lg:py-[128px]" style={{ backgroundColor: '#F8F3EB' }}>
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-3 lg:h-[560px]">
          <SoldHeroCard sale={soldListings[0]} />
          <div className="flex flex-col gap-3 h-full">
            <SoldSideCard sale={soldListings[1]} />
            <SoldSideCard sale={soldListings[2]} />
          </div>
        </div>
