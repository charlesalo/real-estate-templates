  ...
  return (
    <section className="pt-[112px] pb-[64px] lg:pt-[144px] lg:pb-[80px]" style={{ backgroundColor: '#F8F3EB' }}>
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <h1 className="text-[43px] lg:text-[58px] font-normal text-[#24180F] leading-[1.05] mb-4 text-balance" style={{ fontFamily: 'var(--font-gelasio, Georgia, serif)' }}>
          Writing
        </h1>
        <p className="text-[16px] text-[#24180F]/50 max-w-xl mb-12 text-pretty">
          ...
          {BLOG_POSTS.map((post) => (
            <Link key={post.slug} href={`/local-expert/blog/${post.slug}`} className="group block">
              <article>
                ...
                <h2 className="text-[19px] font-normal text-[#24180F] leading-snug group-hover:text-[#BA5B3E] transition-colors mb-2 text-balance" style={{ fontFamily: 'var(--font-gelasio, Georgia, serif)' }}>
                  {post.title}
                </h2>
